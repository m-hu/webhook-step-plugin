...
@Extension
public class WithWebhookRootAction extends CrumbExclusion implements UnprotectedRootAction {

    private static final HashMap<String, WithWebhookStepExecution> webhooks = new HashMap<>();
    ...
    public String getUrlName() {
        return "with-webhook-step";
    }

    @POST
    public void doDynamic(StaplerRequest request, 
        ...
        Logger.getLogger(WithWebhookRootAction.class.getName())
                .info("Webhook called with " + token);

        WithWebhookStepExecution exec;
    ...
    public static WebhookResponse registerWebhook(WithWebhookStepExecution exec) {
        Logger.getLogger(WithWebhookRootAction.class.getName())
    ...
    public static void deregisterWebhook(WithWebhookStepExecution exec) {
        Logger.getLogger(WithWebhookRootAction.class.getName())
